...
+-----------------------------------------------+-----------------------------------------------------------------------+
| General textbook on relativistic quantum chemistry | Dyall, K. G. and Faegri, Jr. K. , Oxford University Press, 2007. |
+-----------------------------------------------+-----------------------------------------------------------------------+
| Used in the construction of the relativistic basis | Kutzelnig W.,  Int. J. Quant. Chem., **25** 107-129, 1984        |
+-----------------------------------------------+-----------------------------------------------------------------------+
